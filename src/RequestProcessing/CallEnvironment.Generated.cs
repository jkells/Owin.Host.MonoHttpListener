...
namespace Owin.Host.MonoHttpListener.RequestProcessing
{
    ...
    internal partial class CallEnvironment
    {
        ...
        internal Mono.Net.HttpListener Listener
        {
            get
            {
                return _Listener;
        ...
        private IEnumerable<string> PropertiesKeys()
        {
            ...
            {
                yield return "Mono.Net.HttpListenerContext";
            }
            if (((_flag0 & 0x80000000u) != 0))
            {
                yield return "Mono.Net.HttpListener";
            }
            if (((_flag1 & 0x1u) != 0))
            {
        ...
        private IEnumerable<KeyValuePair<string, object>> PropertiesEnumerable()
        {
            ...
            if (((_flag0 & 0x40000000u) != 0))
            {
                yield return new KeyValuePair<string, object>("Mono.Net.HttpListenerContext", RequestContext);
            }
            if (((_flag0 & 0x80000000u) != 0))
            {
                yield return new KeyValuePair<string, object>("Mono.Net.HttpListener", Listener);
            }
            if (((_flag1 & 0x1u) != 0))
            {

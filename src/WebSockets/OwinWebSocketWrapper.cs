// <copyright file="OwinWebSocketWrapper.cs" company="Microsoft Open Technologies, Inc.">
...
namespace Owin.Host.MonoHttpListener.WebSockets
{
    ...
    internal class OwinWebSocketWrapper
    {
        ...
        {
            // Remap close messages to CloseAsync.  Mono.Net.WebSockets.WebSocket.SendAsync does not allow close messages.
            if (messageType == 0x8)
            {
